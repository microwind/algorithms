...
if __name__ == "__main__":
    ...
    # Test Case 4: Descending order (worst case for greedy)
    ...
    # Test Case 5: Ascending order (best case for greedy)
    ...
    # Test Case 7: Remove zero digits
    ...
    # Test Case 8: Mixed with leading zeros
    ...
    # Test Case 10: Complex case with tracking
