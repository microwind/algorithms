...
func selectionSort2(_ arr: inout [Int]) {
    print("selectionSort2 descending:")
    let n = arr.count
...
func selectionSort3(_ arr: inout [Int]) {
    print("selectionSort3 bidirectional:")
    let n = arr.count
    var left = 0
    var right = n - 1
...
func selectionSort4(_ arr: inout [Int]) {
    print("selectionSort4 heap optimized:")
    let n = arr.count
...
// 测试2：降序版本
performanceTest(selectionSort2, arr: testData, name: "降序版本")

// 测试3：双向选择版本
performanceTest(selectionSort3, arr: testData, name: "双向选择版本")

// 测试4：堆优化版本
performanceTest(selectionSort4, arr: testData, name: "堆优化版本")
