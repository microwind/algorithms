...
各子目录中的「AI时代-重温…」系列文档，在同一算法的 README 基础上补充生活类比、示意图与多种实现思路对照。

| 算法 | 文档 |
|------|------|
| 冒泡排序 | [AI时代-重温冒泡排序](./bubblesort/AI时代-重温冒泡排序-不同实现思路详解.md) |
| 选择排序 | [AI时代-重温选择排序](./selectionsort/AI时代-重温选择排序-不同实现思路详解.md) |
| 插入排序 | [AI时代-重温插入排序](./insertsort/AI时代-重温插入排序-不同实现思路详解.md) |
| 希尔排序 | [AI时代-重温希尔排序](./shellsort/AI时代-重温希尔排序-不同实现思路详解.md) |
| 归并排序 | [AI时代-重温归并排序](./mergesort/AI时代-重温归并排序-不同实现思路详解.md) |
| 快速排序 | [AI时代-重温快速排序](./quicksort/AI时代-重温快速排序-不同实现思路详解.md) |
| 堆排序 | [AI时代-重温堆排序](./heapsort/AI时代-重温堆排序-不同实现思路详解.md) |
| 计数排序 | [AI时代-重温计数排序](./countingsort/AI时代-重温计数排序-不同实现思路详解.md) |
| 基数排序 | [AI时代-重温基数排序](./radixsort/AI时代-重温基数排序-不同实现思路详解.md) |
| 桶排序 | [AI时代-重温桶排序](./bucketsort/AI时代-重温桶排序-不同实现思路详解.md) |
...
| 排序算法 | C | C++ | Java | Go | Python | JavaScript | TypeScript | Rust | Kotlin | Dart | Swift |
|---------|---|-----|------|----|--------|------------|------------|------|------|------|-------|
| **冒泡排序** | [C](./bubblesort/bubble_sort.c) | [C++](./bubblesort/bubble_sort.cpp) | [Java](./bubblesort/BubbleSort.java) | [Go](./bubblesort/bubble_sort.go) | [PY](./bubblesort/bubble_sort.py) | [JS](./bubblesort/bubble_sort.js) | [TS](./bubblesort/BubbleSort.ts) | [Rust](./bubblesort/bubble_sort.rs) | [Kotlin](./bubblesort/BubbleSort.kt) | [Dart](./bubblesort/bubble_sort.dart) | [Swift](./bubblesort/bubble_sort.swift) |
| **选择排序** | [C](./selectionsort/selection_sort.c) | [C++](./selectionsort/selection_sort.cpp) | [Java](./selectionsort/SelectionSort.java) | [Go](./selectionsort/selection_sort.go) | [PY](./selectionsort/selection_sort.py) | [JS](./selectionsort/selection_sort.js) | [TS](./selectionsort/SelectionSort.ts) | [Rust](./selectionsort/selection_sort.rs) | [Kotlin](./selectionsort/SelectionSort.kt) | [Dart](./selectionsort/selection_sort.dart) | [Swift](./selectionsort/selection_sort.swift) |
| **插入排序** | [C](./insertsort/insert_sort.c) | [C++](./insertsort/insert_sort.cpp) | [Java](./insertsort/InsertSort.java) | [Go](./insertsort/insert_sort.go) | [PY](./insertsort/insert_sort.py) | [JS](./insertsort/insert_sort.js) | [TS](./insertsort/InsertSort.ts) | [Rust](./insertsort/insert_sort.rs) | [Kotlin](./insertsort/InsertSort.kt) | [Dart](./insertsort/insert_sort.dart) | [Swift](./insertsort/insert_sort.swift) |
| **希尔排序** | [C](./shellsort/shell_sort.c) | [C++](./shellsort/shell_sort.cpp) | [Java](./shellsort/ShellSort.java) | [Go](./shellsort/shell_sort.go) | [PY](./shellsort/shell_sort.py) | [JS](./shellsort/shell_sort.js) | [TS](./shellsort/ShellSort.ts) | [Rust](./shellsort/shell_sort.rs) | [Kotlin](./shellsort/ShellSort.kt) | [Dart](./shellsort/shell_sort.dart) | [Swift](./shellsort/shell_sort.swift) |
| **快速排序** | [C](./quicksort/quick_sort.c) | [C++](./quicksort/quick_sort.cpp) | [Java](./quicksort/QuickSort.java) | [Go](./quicksort/quick_sort.go) | [PY](./quicksort/quick_sort.py) | [JS](./quicksort/quick_sort.js) | [TS](./quicksort/QuickSort.ts) | [Rust](./quicksort/quick_sort.rs) | [Kotlin](./quicksort/QuickSort.kt) | [Dart](./quicksort/quick_sort.dart) | [Swift](./quicksort/quick_sort.swift) |
| **归并排序** | [C](./mergesort/merge_sort.c) | [C++](./mergesort/merge_sort.cpp) | [Java](./mergesort/MergeSort.java) | [Go](./mergesort/merge_sort.go) | [PY](./mergesort/merge_sort.py) | [JS](./mergesort/merge_sort.js) | [TS](./mergesort/MergeSort.ts) | [Rust](./mergesort/merge_sort.rs) | [Kotlin](./mergesort/MergeSort.kt) | [Dart](./mergesort/merge_sort.dart) | [Swift](./mergesort/merge_sort.swift) |
| **堆排序** | [C](./heapsort/heap_sort.c) | [C++](./heapsort/heap_sort.cpp) | [Java](./heapsort/HeapSort.java) | [Go](./heapsort/heap_sort.go) | [PY](./heapsort/heap_sort.py) | [JS](./heapsort/heap_sort.js) | [TS](./heapsort/HeapSort.ts) | [Rust](./heapsort/heap_sort.rs) | [Kotlin](./heapsort/HeapSort.kt) | [Dart](./heapsort/heap_sort.dart) | [Swift](./heapsort/heap_sort.swift) |
| **计数排序** | [C](./countingsort/counting_sort.c) | [C++](./countingsort/counting_sort.cpp) | [Java](./countingsort/CountingSort.java) | [Go](./countingsort/counting_sort.go) | [PY](./countingsort/counting_sort.py) | [JS](./countingsort/counting_sort.js) | [TS](./countingsort/CountingSort.ts) | [Rust](./countingsort/counting_sort.rs) | [Kotlin](./countingsort/CountingSort.kt) | [Dart](./countingsort/counting_sort.dart) | [Swift](./countingsort/counting_sort.swift) |
| **基数排序** | [C](./radixsort/radix_sort.c) | [C++](./radixsort/radix_sort.cpp) | [Java](./radixsort/RadixSort.java) | [Go](./radixsort/radix_sort.go) | [PY](./radixsort/radix_sort.py) | [JS](./radixsort/radix_sort.js) | [TS](./radixsort/RadixSort.ts) | [Rust](./radixsort/radix_sort.rs) | [Kotlin](./radixsort/RadixSort.kt) | [Dart](./radixsort/radix_sort.dart) | [Swift](./radixsort/radix_sort.swift) |
| **桶排序** | [C](./bucketsort/bucket_sort.c) | [C++](./bucketsort/bucket_sort.cpp) | [Java](./bucketsort/BucketSort.java) | [Go](./bucketsort/bucket_sort.go) | [PY](./bucketsort/bucket_sort.py) | [JS](./bucketsort/bucket_sort.js) | [TS](./bucketsort/BucketSort.ts) | [Rust](./bucketsort/bucket_sort.rs) | [Kotlin](./bucketsort/BucketSort.kt) | [Dart](./bucketsort/bucket_sort.dart) | [Swift](./bucketsort/bucket_sort.swift) |
