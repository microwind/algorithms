...
var BinarySearch = /** @class */ (function () {
    ...
    BinarySearch.prototype.search1 = function (arr, target) {
        var left = 0;
    ...
    // 递归实现，移动左右区间指针
    BinarySearch.prototype.search2 = function (arr, target, left, right) {
    ...
    BinarySearch.prototype.search3 = function (arr, target) {
        var left = 0;
        var right = arr.length - 1;
        var midIndex, mid;
        // 搜索区间小于等于1停止搜索
    ...
    //  二分搜索递归查找，记录下右侧位置
    BinarySearch.prototype.search4 = function (arr, target, resultIndex) {
