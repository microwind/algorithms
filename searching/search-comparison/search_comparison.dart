 ...
 * @returns {int} 找到返回索引，未找到返回-1
 */
int hashSearch(List<int> arr, int target) {
    // 构建哈希表
 ...
 * 
 * @param {List<int>} arr - 有序数组
 * @param {List<int>} unsortedArr - 无序数组
 * @param {int} target - 目标值
 */
void testAlgorithms(List<int> arr, List<int> unsortedArr, int target) {
    print('\n数组大小: ${arr.length}');
    print('查找目标: $target');
    ...
    stopwatch.stop();
    print('二分查找:     索引=$result, 时间=${stopwatch.elapsedMilliseconds}ms');
    ...
    stopwatch.stop();
    print('跳跃查找:     索引=$result, 时间=${stopwatch.elapsedMilliseconds}ms');
    ...
    stopwatch.stop();
    print('指数查找:     索引=$result, 时间=${stopwatch.elapsedMilliseconds}ms');
    ...
    stopwatch.stop();
    print('插值查找:     索引=$result, 时间=${stopwatch.elapsedMilliseconds}ms');
    ...
    stopwatch.stop();
    print('哈希查找:     索引=$result, 时间=${stopwatch.elapsedMilliseconds}ms');
    ...
    stopwatch.stop();
    print('线性查找:     索引=$result, 时间=${stopwatch.elapsedMilliseconds}ms');
}
...
void main() {
    ...
    // 创建测试数据
    int n = 10000;
    List<int> sortedArr = List.generate(n, (i) => i);
    List<int> unsortedArr = List.generate(n, (i) => n - 1 - i); // 逆序
...
/*
打印结果
jarry@Mac search-comparison % dart search_comparison.dart
============================================================
搜索算法综合对比
============================================================
