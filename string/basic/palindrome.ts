...
function isPalindromeRecursiveHelper(s: string, left: number, right: number): boolean {
    if (left >= right) {
        return true;
    }
    if (s[left] !== s[right]) {
 ...
 */
function testPalindromeChecker(): void {
    console.log("=".repeat(60));
    console.log("Palindrome Checker - TypeScript Implementation");
    console.log("=".repeat(60));
