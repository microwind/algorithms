...
/*
jarry@192 nativesearch % tsc -version
Version 3.8.3
jarry@192 nativesearch % node -v     
v10.13.0
jarry@192 nativesearch % tsc StringSearch.ts -m es2020 
jarry@192 nativesearch % node StringSearch.js
find('ABC', 'AABABC') 3
find('AAB', 'AAAABC') 2
find('ABC', 'AABAC') -1
time: 2.433ms
