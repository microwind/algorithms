...
class TreeTraversal {
     ...
     * - 文件系统目录结构遍历
     */
    static preorderRecursive(root) {
        const result = [];
        this.preorderRecursiveHelper(root, result);
        return result;
    }
    static preorderRecursiveHelper(node, result) {
        if (node === null)
            return;
     ...
     * - 有序数据处理
     */
    static inorderRecursive(root) {
        const result = [];
        this.inorderRecursiveHelper(root, result);
        return result;
    }
    static inorderRecursiveHelper(node, result) {
        if (node === null)
            return;
     ...
     * - 后缀表达式生成
     */
    static postorderRecursive(root) {
        const result = [];
        this.postorderRecursiveHelper(root, result);
        return result;
    }
    static postorderRecursiveHelper(node, result) {
        if (node === null)
            return;
     ...
     * 打印遍历结果
     */
    static printTraversalResult(title, result) {
    ...
    static test() {
        ...
        console.log("树遍历算法测试 - JavaScript实现");
        console.log("=".repeat(60));
        console.log("测试树结构:");
        console.log("       1");
        console.log("      / \\");
...
module.exports = { TreeNode, TreeTraversal };
