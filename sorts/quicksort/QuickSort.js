...
class QuickSort {
   ...
   */
    ...
    quickSort2(arr, left, right) {
        ...
        // 左侧小于基数位置，不断递归左边部分
        if (left < j) {
            console.log("left < j:recursion:  left=" +
                left +
                " right=" +
                right +
                " i=" +
        ...
        // 基数位置小于右侧，不断递归右侧部分
        if (i < right) {
            console.log("i < right:recursion:  left=" +
                left +
                " right=" +
                right +
                " i=" +
  ...
  */
    ...
    quickSort3(arr) {
        ...
        var stack = [], i, j, midIndex, pivot, tmp;
...
/**
jarrys-MacBook-Pro:quicksort jarry$ tsc QuickSort.ts -t es2020
jarrys-MacBook-Pro:quicksort jarry$ node QuickSort.js
origin: [ 7, 11, 9, 10, 12, 13, 8 ]
