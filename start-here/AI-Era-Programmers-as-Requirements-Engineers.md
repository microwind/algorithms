...
graph LR
    ...
    B1["1. 能挖掘隐需求<br/> 2. 能发现需求矛盾<br/> 3. 能做权衡分析<br/> 4. 能用框架结构化需求"]
...
```
这些方法的核心思想是：需求不是一次写完，而是通过检查、扩展、验证不断迭代完善。
```
...
### 相关链接
- [本文档](https://github.com/microwind/algorithms/blob/main/start-here/AI-Era-Programmers-as-Requirements-Engineers.md)
