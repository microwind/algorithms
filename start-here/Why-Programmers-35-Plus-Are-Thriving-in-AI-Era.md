...
我有个同事用AI写了个推荐算法。AI用了MMR（最大边际相关性）来平衡多样性和相关性，逻辑完全正确，代码也对。

但他没想到一个细节：新用户怎么办？没有历史行为数据，算法根本跑不了。

AI没有提醒这个边界情况，一验证就发现问题了。这就是"边界情况遗漏"。
...
而这个能力，只有经验丰富的程序员才有。年前程序员可能做不了，因为他不知道什么该查。

---

## 五、新老程序员的优劣势对比

如果拼写代码，尤其是CRUD的逻辑开发，老程序员的确不如新手，
